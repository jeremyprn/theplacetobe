...
const getSecurityByPop = (data: TPoi[], population: number): number => {
  const rating = Number((data.length / population).toFixed(2));
  return rating;
};

const getShopByPop = (data: TPoi[], population: number): number => {
  const rating = Number(((data.length / population) * 5500).toFixed(2));
  return rating;
};

const getHealthcareByPop = (data: TPoi[], population: number): number => {
  const rating = Number(((data.length / population) * 15000).toFixed(2));
  return rating;
};
...
const getEducationByPop = (data: TPoi[], population: number): number => {
  const rating = Number(((data.length / population) * 14000).toFixed(2));
  return rating;
};
...
const getRestaurantByPop = (data: TPoi[], population: number): number => {
  const rating = Number(((data.length / population) * 5000).toFixed(2));
  return rating;
};
...
const getServiceByPop = (data: TPoi[], population: number): number => {
  const rating = Number(((data.length / population) * 65000).toFixed(2));
  return rating;
};
